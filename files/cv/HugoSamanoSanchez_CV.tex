...
\cventry{10/15 - 01/20}{PhD Student / Bridging Postdoctoral Fellow}{}{European Molecular Biology Laboratory}{Heidelgerg, Germany}{
  \begin{itemize}
    ...
    \item Computational screening for Eukaryotic Short Linear Motifs mimicked by bacterial proteins. Four publications.
...
\vspace{.1cm}
\begin{itemize}
  \item Mezsaros, B., \textbf{\underline{S\'amano-S\'anchez, H.}}, Alvarado-Valverde, J., Calyseva, J., Martinez-Perez, E., Alves, R., Kumar, M., Rippmann, F., Chemes, L.B., Gibson, T.J. Short linear motif candidates in the cell entry system used by SARS-CoV-2 and their potential therapeutic implications. \textit{ArXiv}, 2020. \href{https://arxiv.org/abs/2004.10274}{arXiv:2004.10274}
...
\textbf{Lecturer}
\begin{itemize}
  \item Graph algorithms part of Biomedical Informatics Course, Zhejiang University-University of Edinburgh Institute, China, 2020.
...
\cvitem{Software}{ggplot2, Git, Singularity, PyMOL, UCSF Chimera, Modeller, MEGA, IGV, XCMS, \LaTeX}
