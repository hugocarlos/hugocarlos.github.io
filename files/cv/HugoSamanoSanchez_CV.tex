...
%\email{\date{}}
%\extrainfo{Birth date: November 8th, 1988.}
...
\begin{itemize}
  \item Integrative Biomedical Informatics year 3, Biomedical Informatics and Biomedical Sciences Programmes, Zhejiang University-University of Edinburgh Institute, China, 2022.
...
\textbf{Lecturer}
\begin{itemize}
  \item Advanced Mathematics 1 (AM1), Introduction to Biomedical Informatics 1 (IBI1), Integrative Biomedical Sciences 1 and 3 (IBMS1,3), Introduction to Cellular and Molecular Biology 1 (ICMB1), Applied Data Sciences 2 (ADS2), Genomics and Proteomics 2 (GP2), Microorganisms and Immunity 2 (IM2), Infection 3 (IN3), Biomedical Informatics 3 (BMI3), Computational Biology and Systems Biology 3 (CBSB3) courses of the Biomedical Informatics and Biomedical Sciences Programmes, Zhejiang University-University of Edinburgh Institute, China, 2020-2022.
  \item Biomedical Disorders 1 course of the Integrative Biomedical Sciences PhD programme, Zhejiang University-University of Edinburgh Institute, China, 2021-2022.
...
\cvitem{Software}{ggplot2, Git, SLURM, Singularity, PyMOL, UCSF Chimera, Modeller, MEGA, IGV, XCMS, Bowtie2, minimap2, samtools, Alfred, \LaTeX}
